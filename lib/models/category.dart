...
class Category {
  ...
  static List<Category> get defaultCategories {
    ...
    const seeds = <List<String>>[
      ['general', 'General', 'General news and articles', 'newspaper', '#94A3B8'],
      ['news', 'News & Politics', 'World news, politics and current affairs',
        'public', '#60A5FA'],
      ['technology', 'Technology', 'Tech news, gadgets and industry updates',
        'memory', '#22D3EE'],
      ['programming', 'Programming', 'Software development and engineering',
        'code', '#A78BFA'],
      ['science', 'Science', 'Research, space and discovery', 'science',
        '#34D399'],
      ['business', 'Business & Finance', 'Markets, economy and startups',
        'trending_up', '#FBBF24'],
      ['sports', 'Sports', 'Scores, analysis and sports news', 'sports_soccer',
        '#FB923C'],
      ['entertainment', 'Entertainment', 'Film, TV, music and celebrity news',
        'movie', '#F472B6'],
      ['gaming', 'Gaming', 'Video games, reviews and esports',
        'sports_esports', '#C084FC'],
      ['health', 'Health', 'Health, fitness and medicine', 'favorite',
        '#F87171'],
      ['culture', 'Art & Design', 'Art, design and architecture', 'palette',
        '#E879F9'],
      ['lifestyle', 'Lifestyle', 'Food, travel and everyday living', 'spa',
        '#4ADE80'],
    ];
