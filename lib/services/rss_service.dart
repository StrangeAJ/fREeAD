...
class RSSService {
  ...
  Future<List<Article>> fetchFeed(String url, String feedId) async {
    return parseRSSFeed(url, feedId);
  }
  ...
  Future<List<dynamic>> fetchFeedPreview(String url) async {
    final feed = await fetchFeedInfo(url);
