...
with open('lib/services/summarization_service.dart', 'r') as f:
    content = f.read()

# Add import
import_stmt = "import 'package:google_generative_ai/google_generative_ai.dart';\n"
if import_stmt not in content:
    content = content.replace("import '../providers/settings_provider.dart';", "import '../providers/settings_provider.dart';\n" + import_stmt)


old_gemini = """  // Fix Gemini summarization to use proper Google AI API
...
new_gemini = """  // Fix Gemini summarization to use proper Google AI API
...
with open('lib/services/summarization_service.dart', 'w') as f:
    f.write(content)
